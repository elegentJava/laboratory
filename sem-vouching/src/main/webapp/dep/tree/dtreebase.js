...
function dTree(objName) {
	...
	this.icon = {
		...
		root : "/vouching/dep/tree/img/base.gif",

		folder : '/vouching/dep/tree/img/folder.gif',

		folderOpen : '/vouching/dep/tree/img/folderopen.gif',

		node : '/vouching/dep/tree/img/page.gif',

		empty : '/vouching/dep/tree/img/empty.gif',

		line : '/vouching/dep/tree/img/line.gif',

		join : '/vouching/dep/tree/img/join.gif',

		joinBottom : '/vouching/dep/tree/img/joinbottom.gif',

		plus : '/vouching/dep/tree/img/plus.gif',

		plusBottom : '/vouching/dep/tree/img/plusbottom.gif',

		minus : '/vouching/dep/tree/img/minus.gif',

		minusBottom : '/vouching/dep/tree/img/minusbottom.gif',

		nlPlus : '/vouching/dep/tree/img/nolines_plus.gif',

		nlMinus : '/vouching/dep/tree/img/nolines_minus.gif'
