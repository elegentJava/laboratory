			...
			<tr>	
				<td width="50%" bgcolor="#1D6300" height="30">
				 ...
				 <td width="50%" height="30" align="right" bgcolor="#1D6300">
				     <img src="/vouching/images/mes_btn1.jpg" alt="" width="166" height="35" border="0" usemap="#Map2"/>
				 </td>
		  	</tr>
  			<tr>
...
<script type="text/javascript" src="/vouching/js/front/email/email.receive.box.js"></script>
</html>