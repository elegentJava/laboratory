...
<script type="text/javascript" src="<%=bp%>/js/back/user/addstudent.js"></script>
<title>添加学生信息</title>
</head>
<body>
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong><span class="icon-pencil-square-o"></span>添加学生信息</strong>
		</div>
		<div class="body-content form-x">
			<div class="form-group">
				<div class="label"><label>账号(学号)：</label></div>
				<div class="field">
